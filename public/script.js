document.addEventListener('DOMContentLoaded', () => {
    ...
    if (gateForm) {
        gateForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                gateSubmitBtn.innerHTML = '<i class="fa-solid fa-arrow-right-to-bracket"></i> Login';
            }
        });
    }
    ...
    function finishSendingUI() {
        ...
        if (sendBtn) {
            ...
            sendBtn.innerHTML = '<i class="fa-solid fa-paper-plane"></i> Send All (6x Fast)';
        }
    }
        ...
        sendBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                if (stopRequested) {
                    ...
                    alert(`Completed! Delivered: ${sentCount}, Failed: ${failedCount}`);
                }
