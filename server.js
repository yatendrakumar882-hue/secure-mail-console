...
app.post("/api/send-batch", async (req, res) => {
  ...
  for (let index = 0; index < recipients.length; index++) {
      ...
      // Introduce a dynamic high-speed humanized stagger delay (200ms - 400ms) between emails
      // This is extremely fast (13 emails in ~3.9 seconds) but lets Gmail process each connection request cleanly
