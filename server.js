    ...
    const sendPromises = batch.map(async (rawRecipient, idx) => {
      ...
      try {
        ...
        if (isHtml) {
          ...
          cleanBodyHtml = `<div dir="ltr" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size: 18px; color: #1e293b; line-height: 1.6;">${personalizedBody.replace(/\n/g, '<br>')}</div>`;
        }
