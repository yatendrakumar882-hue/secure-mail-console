...
// Site password and Turnstile keys from environment variable
...
/* ==========================================================================
   SMTP TRANSPORTER POOLING & CACHING (High-Speed Optimized)
   ========================================================================== */
const transporters = {};
  ...
  for (let index = 0; index < recipients.length; index++) {
      ...
      while (attempts < maxAttempts) {
          try {
              ...
              lastError = error;
              attempts++;
              console.warn(`[SMTP Retry Warning] Attempt ${attempts}/${maxAttempts} failed:`, error.message);
          }
      }
